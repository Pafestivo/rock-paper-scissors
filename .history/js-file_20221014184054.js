...
function getComputerChoice() {
  ...
  if(selected === "Rock") {
    ...
    const icon = document.getElementsByClassName('comp-choice');
    rockChosen.removeChild(icon.lastElementChild);
    rockChosen.insertAdjacentHTML('beforeend', '<i class="fa-solid fa-robot comp-choice"></i>')
  }
